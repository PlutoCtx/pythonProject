...
parser = argparse.ArgumentParser(
    description="Use this script to run TensorFlow implementation (https://github.com/argman/EAST) of "
                ...
                "The OCR model can be obtained from converting the pretrained CRNN model to .onnx format "
                "from the github repository https://github.com/meijieru/crnn.pytorch"
                "Or you can download trained OCR model directly from "
...
def main():
    ...
    while cv.waitKey(1) < 0:
        ...
        cv.putText(frame, label, (0, 25), cv.FONT_HERSHEY_SIMPLEX, 1, (255, 0, 0),2)
